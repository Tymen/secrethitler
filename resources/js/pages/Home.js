                    ...
                    <div className="row text-white container-explanation explanation-text">
                        ...
                        <div className="col-12 my-2">
                            <p>
                                ...
                                before the game starts the roles will be randomly distributed among the players in the
                                game.
                            </p>
                            <p className="explanation-text-nospace">
                                ...
                                them.
                                When Hitler is killed the liberals will win the game, liberals can also win by filling
                                in
