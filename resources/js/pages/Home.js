                    ...
                    <div className="col-12 my-2">
                        ...
                        <div className="row text-white container-explanation explanation-text">
                            ...
                            <div className="col-12 my-2">
                                <p>
                                    Secret Hitler is a card game, in the game you have liberals and fascists.
                                    before the game starts the roles will be randomly distributed among the players in
                                    the
                                    game.
                                </p>
                                <p className="explanation-text-nospace">
                                    The goal for the liberals is to find out who the fascist are and Hitler and then to
                                    kill
                                    them.
                                    When Hitler is killed the liberals will win the game, liberals can also win by
                                    filling
                                    in
                                    all policy spots on the the blue side of the board (total of five blue policy
                                    cards).
                                </p>
                                <p>
                                    As a fascist, you have to thwart the liberals and try to make the
                            ...
                            <div className="col-12 explanation-text-nospace">
                                ...
                                <p>
                                    -&nbsp;&nbsp;&nbsp;&nbsp;The red side of the board is filled with red policy
                                    cards(fascists
                                    win)
                                </p>
                                <p> -&nbsp;&nbsp;&nbsp;&nbsp;The blue side is filled with blue policy cards(liberals
                                    win)</p>
                                <p>
                                    -&nbsp;&nbsp;&nbsp;&nbsp;If Hitler becomes the chancellor by four or more red policy
                                    cards
                                    on
                                    the board
                                </p>
