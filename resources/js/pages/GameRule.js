            ...
            <div className="container">
                ...
                <div className="row gamerule">
                    ...
                    <div className="col-6 mb-5">
                        ...
                        <div className="text d-block"><p>In het spel heb je een president en een
                            kanselier. Deze hebben dan in die ronde
                            de kans policy kaarten te kiezen.
                        </p></div>
                        {/*Het bord*/}
                        <div className="title"><h1>- Het bord:</h1></div>
                        <div className="text d-block"><p>Het bord bevat twee kanten de “rode” en
                        ...
                        <div className="text d-block"><p>Geld er dat bij de derde rode policy kaart de vorige president de drie policykaarten mag inzien. Zo kan hij kijken of er een fascist tussen de huidige president en kanselier zit (de vorige president kan zelf een fascist zijn).
                        ...
                        <div className="text d-block"><p>-	Hitler vermoord is (liberalen winnen)
                    ...
                    <div className="text d-block"><p>Blauwe “Policy kaarten”:</p>
                        <p>Deze wil je als liberaal</p>
                        ...
                        <div className="text d-block"><p>Geld er dat bij de tweede rode policykaart die op het bord gelegd word de president iemand mag kiezen om zijn identiteit kaart te zien(hierover mogen beide spelers over liegen).
                        ...
                        {/*Regels zonder x aantal*/}
                        <div className="title"><h1>-  Regels zonder een x aantal spelers:</h1></div>
                        <div className="text d-block"><p>Bij de vijfde policykaart mag diegene die hem oplegt iemand vermoorden als liberaal wil je een fascist doden en als fascist juist een liberaal. Dit geld ook voor de zesde rode policykaart.
                        ...
                        <div className="text d-block"><p>Elke ronde word er een nieuwe president aangesteld (de eerste keer is dit random) deze word telkens met de klok mee aangesteld. De president kiest vervolgens een kanselier. Vervolgens gaan alle spelers stemmen of zij de kanselier goedkeuren. Hiervoor heb je een “Ja” en “Nein” kaarten. Als er meer dan 50% ja gekozen heeft mogen ze de policy kaarten pakken.
                            <img className="" width="150" src="images/gamerule/ja-card.png"/><img className="" width="150" src="images/gamerule/nein-card.png"/>
